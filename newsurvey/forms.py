...
class Emp_form(forms.Form):
    ...
    emp_name = forms.CharField(max_length=40,
                                  widget=forms.TextInput(attrs={'class': 'form-control',
                                                                'placeholder': 'empname'}))
    emp_username = forms.CharField(max_length=40,
                                  widget=forms.TextInput(attrs={'class': 'form-control',
                                                                'placeholder': 'euname'}))

    emp_password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control',
                                                                    'placeholder': 'password'}))
    emp_designation = forms.CharField(max_length=40,
                                  widget=forms.TextInput(attrs={'class': 'form-control',
                                                                'placeholder': 'designation'}))

    emp_address = forms.EmailField(max_length=40,
                                   widget=forms.TextInput(attrs={'class': 'form-control',
                                                                 'placeholder': 'email'}))
    company = forms.CharField(max_length=40,
                              widget=forms.TextInput(attrs={'class': 'form-control',
